...
public class DiaryImgController {
    ...
    public ApiResponse selectRecommendImage(@RequestBody RecommendImageRequest recommendImageRequest) {
    ...
    public ApiResponse getRecommendImage(@RequestParam Long diaryId) {
        ...
        return new ApiResponse<String>().ok(List.of(diaryImgService.findRecommendImage(diaryId).getImgUrl()));
    }
}
